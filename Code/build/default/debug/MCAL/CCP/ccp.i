...
# 1 "MCAL/CCP/ccp.h" 1
# 12 "MCAL/CCP/ccp.h"
# 1 "MCAL/CCP/../../MCAL/GPIO/hal_gpio.h" 1
# 17 "MCAL/CCP/../../MCAL/GPIO/hal_gpio.h"
# 1 "MCAL/CCP/../../MCAL/GPIO/../../MCAL/mcal_std_types.h" 1
# 17 "MCAL/CCP/../../MCAL/GPIO/../../MCAL/mcal_std_types.h"
...
# 17 "MCAL/CCP/../../MCAL/GPIO/../../MCAL/mcal_std_types.h" 2
...
# 18 "MCAL/CCP/../../MCAL/GPIO/../../MCAL/mcal_std_types.h" 2
...
# 17 "MCAL/CCP/../../MCAL/GPIO/hal_gpio.h" 2


# 1 "MCAL/CCP/../../MCAL/GPIO/../config.h" 1
# 17 "MCAL/CCP/../../MCAL/GPIO/../config.h"
...
# 19 "MCAL/CCP/../../MCAL/GPIO/hal_gpio.h" 2
# 36 "MCAL/CCP/../../MCAL/GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 1 "MCAL/CCP/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/CCP/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/CCP/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/CCP/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/CCP/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/CCP/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/CCP/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/CCP/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/CCP/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/CCP/../INTERRUPT/manage_interrupt.h" 2
...
void ISR_CCP1(void);
void ISR_CCP2(void);
# 19 "MCAL/CCP/../INTERRUPT/internal_interrupt.h" 2
# 14 "MCAL/CCP/ccp.h" 2
# 66 "MCAL/CCP/ccp.h"
typedef enum{
...
static void __attribute__((inline)) CCP1_Interrupt_Config(const ccp_t *ccp1_obj);
static void __attribute__((inline)) CCP2_Interrupt_Config(const ccp_t *ccp2_obj);

static Std_ReturnType CCP1_Init(const ccp_t *ccp1_obj);
static Std_ReturnType CCP2_Init(const ccp_t *ccp2_obj);

static void __attribute__((inline)) CCP_select_timer(const ccp_t *ccp_obj);
...
Std_ReturnType CCP_Is_CaptureDataReady(const ccp_t *ccp_obj, uint8 *capture_status){
    Std_ReturnType ret = (Std_ReturnType)1;
    if(((void*)0) == ccp_obj || ((void*)0) == capture_status){
        ret = (Std_ReturnType)1;
    }
    else{
        if(CCP1_INST == ccp_obj->ccp_inst){
